                ...
                <td>
                    ...
                    <table>
                        <tr>
                            ...
                            <td> <button type="button" class="btn btn-primary btn-sm edit_news" data-id="{{ $new->id}}" data-toggle="modal" data-target="#newsModal">Edit</button>
                            </td>
                            <td>{!! Form::open([    'method' => 'DELETE','route' => ['news.destroy', $new->id]]) !!}{!! Form::submit('Delete', ['class' => 'btn btn-danger btn-sm']) !!}{!! Form::close() !!}
                            </td>
                        </tr>
                    </table>
